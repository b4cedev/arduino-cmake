...
function(_get_board_property BOARD_ID PROPERTY_NAME OUTPUT_VAR)
    _try_get_board_property(${BOARD_ID} ${PROPERTY_NAME} VALUE)
    if (NOT VALUE)
...
function(_try_get_board_property BOARD_ID PROPERTY_NAME OUTPUT_VAR)
    ...
    # first try getting the value using additional tags (menu selections)
    foreach (TAG ${BOARD_TAGS})
        set(VALUE ${${BOARD_NAME}.menu.${TAG}.${PROPERTY_NAME}})
        if (VALUE)
            break()
        endif()
    endforeach()
